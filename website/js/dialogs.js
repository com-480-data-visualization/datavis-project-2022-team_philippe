...
const texts_l2_s1 = [`Now let's check on<br>your preferences!`, `Go and tune the widgets in the next pages`];
...
const texts_l2_s5 = [`With this in mind...`, `let's look at<br>your bubble book!`];
